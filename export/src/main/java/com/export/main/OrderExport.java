	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	for(int i=1;i<=30;i++){
        		...
        		String[] params = {date,date,date,date,date,date,date,date,date,date,date,date};
        		
        		rs = db.search(sql, params);
        		List<Map<String, Object>> temps = new ArrayList<Map<String,Object>>(listSize);
        		String path = "C:/order/"+date+".xls";
            	...
            	if(count * listSize != totalCount){
            		count++;
            		LargeExcelUtil.writeList(path, headers, columnName, temps, count);
            		temps.clear();
            	}
            	System.out.println(date+"：导出成功，共需要"+count+"次生成文件");
        		System.gc();
        	}
